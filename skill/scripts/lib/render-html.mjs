...
*{box-sizing:border-box}html,body{margin:0;width:100%;height:100%;overflow:hidden;background:#070a12;color:${theme.text};font-family:${theme.fontFamily},${theme.fontFamilyCjk},system-ui,sans-serif}.deck{position:absolute;inset:0;overflow:hidden}.stage{position:absolute;left:50%;top:50%;width:${CANVAS.width}px;height:${CANVAS.height}px;overflow:hidden;background:${theme.background};box-shadow:0 30px 80px #0008;transform-origin:center center;will-change:transform}.slide{display:none;position:absolute;inset:0;overflow:hidden}.slide.active{display:block}.el{position:absolute}.text{display:flex;white-space:pre-wrap;line-height:1.18}.image{display:block}.table-wrap{overflow:hidden}table{border-collapse:collapse;width:100%;height:100%;font-size:22px}th,td{border:1px solid ${theme.muted}66;padding:10px;text-align:left}th{background:${theme.surface};color:${theme.text}}.chart{display:flex;align-items:end;gap:18px;padding:20px}.bar-item{height:100%;flex:1;display:flex;flex-direction:column;justify-content:end;align-items:center;gap:8px;color:${theme.muted};font-size:18px}.bar{width:70%;border-radius:8px 8px 0 0}.toolbar{position:fixed;left:50%;bottom:max(18px,env(safe-area-inset-bottom));z-index:100;max-width:calc(100% - 24px);transform:translateX(-50%);display:flex;align-items:center;gap:8px;padding:8px 10px;border:1px solid #ffffff24;border-radius:999px;background:#0b1020dd;backdrop-filter:blur(12px)}button,.export{min-height:40px;border:0;border-radius:999px;padding:8px 12px;background:#ffffff16;color:white;text-decoration:none;font:inherit;line-height:1.15;cursor:pointer}.export{display:grid;place-items:center;background:${theme.accent}}.counter{min-width:72px;text-align:center;color:${theme.muted};font-size:13px}@media(max-width:600px){.toolbar{bottom:max(10px,env(safe-area-inset-bottom));gap:4px;padding:6px}.toolbar button,.toolbar .export{min-height:44px;padding:8px 10px}.counter{min-width:48px}}@media print{.toolbar{display:none}.stage{box-shadow:none}}
